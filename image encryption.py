...
img=Image.open(r'C:\Users\DELL\Downloads\hemanth\image-encryption-and-decryption-hemanth\tony stark original.jpg')
#img.show()
...
enimg.show()
enimg.save(r'C:\Users\DELL\Downloads\hemanth\image-encryption-and-decryption-hemanth\hemanth encrypted.jpg')
